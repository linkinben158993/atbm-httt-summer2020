...
public class SellerDashBoard extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SellerDashBoard frame = new SellerDashBoard(new User());
	...
	public SellerDashBoard(final User user) {
		this.user = user;
		...
		ImageIcon imageIcon_Medicines = new ImageIcon(SellerDashBoard.class.getResource("/images/Medicines.png"));
		...
		JLabel lblMnHnhChnh = new JLabel("Màn Hình Chính Nhân Viên Bán Thuốc");
		...
		JLabel lblStats = new JLabel("<html>Thống Kê Theo Toa</html>", SwingConstants.CENTER);
		...
		ImageIcon imageIcon_Stats = new ImageIcon(Login.class.getResource("/images/Statistic.png"));
		...
		lblIconStats.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dispose();
				SellerPres sellerWorkSpace = new SellerPres(user);
				genericStuff.call_frame(sellerWorkSpace);
			}
		});
		...
		panelSal.setBounds(120, 191, 100, 116);
		panel.add(panelSal);
