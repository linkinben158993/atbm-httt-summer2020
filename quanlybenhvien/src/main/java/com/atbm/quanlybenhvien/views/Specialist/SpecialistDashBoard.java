...
public class SpecialistDashBoard extends JFrame {
	...
	public SpecialistDashBoard(final User user) {
		...
		ImageIcon imageIcon_Medicines = new ImageIcon(SpecialistDashBoard.class.getResource("/images/Manager.png"));
		...
		JLabel lblMnHnhChnh = new JLabel("Màn Hình Chính Quản Lý Chuyên Môn");
		...
		panelSal.setBounds(230, 191, 100, 116);
		panel.add(panelSal);
		...
		ImageIcon imageIcon_Back = new ImageIcon(SpecialistDashBoard.class.getResource("/images/Back.png"));
