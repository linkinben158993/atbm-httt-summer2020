...
public class ReceptionistPatients extends JFrame {
	...
	public ReceptionistPatients(final User user) {
		...
		label_13.setBounds(281, 247, 330, 14);
		...
		btnSaBnhNhn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tbl_Patients.getSelectedRow() == -1) {
					JOptionPane.showMessageDialog(null, "Vui lòng chọn bệnh nhân để xem chi tiết!");
				} else {
		...
		btnXaBnhNhn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tbl_Patients.getSelectedRow() == -1) {
					JOptionPane.showMessageDialog(null, "Vui lòng chọn bệnh nhân để xóa chi tiết!");
				} else {
