			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (txtHoTen.getText().equals("") || txtMaNV.getText().equals("")
								|| comboBox_Phong.getSelectedItem() == null
								|| comboBox_ChucVu.getSelectedItem() == null) {
							...
							try {
								stmt = conn.prepareStatement("INSERT INTO QLBV.NHANVIEN VALUES (?,?,?,?)");
								...
								stmt.setString(4, comboBox_ChucVu.getSelectedItem().toString());
								stmt.executeUpdate();
								conn.close();
